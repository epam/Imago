//
//  imagotestAppDelegate.m
//  imagotest
//
//  Created by Boris Karulin on 25.11.10.
//  Copyright 2010 __MyCompanyName__. All rights reserved.
//

#import "imagotestAppDelegate.h"

@implementation imagotestAppDelegate

@synthesize window;

void testGetGraph( const char *filename, const char *out_filename );
int testVectorization(const char *filename);
