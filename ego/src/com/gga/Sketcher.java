...
public class Sketcher {
    ...
    public Sketcher(JFrame parent, String molecule) {
        mol = molecule;
        prnt = parent;
    ...
    private void run() {
        try {
            ...
            int n = JOptionPane.showConfirmDialog(prnt,
    ...
    private void showSketcher() {
        JDialog sketcherDialog = new JDialog(prnt, true);
        sketcherDialog.setTitle("MarvinSketch");
        sketcherDialog.setLocation(prnt.getLocation());
    ...
    private void choosePath() {
        ...
        if (jfc.showOpenDialog(prnt) == JFileChooser.APPROVE_OPTION) {
