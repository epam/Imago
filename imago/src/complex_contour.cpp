...
ComplexContour ComplexContour::RetrieveContour(Image& seg)
{
	logEnterFunction();
	...
	//TO REMOVE
	getSettings().set("IsHandwritten", false);
	...
	getLogExt().appendSkeleton("after join vertices", _g);
