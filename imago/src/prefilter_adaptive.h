...
#pragma once
#ifndef _prefilter_adaptive_h
#define _prefilter_adaptive_h
...
namespace imago
{
	...
	// entry for adaptive processing images with default parameters
	bool prefilterAdaptive(Settings& vars, Image& img);
