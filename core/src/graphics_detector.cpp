...
GraphicsDetector::GraphicsDetector(const BaseApproximator* approximator, double eps) : _approximator(approximator), _approx_eps(eps)
{
}
...
void GraphicsDetector::analyzeUnmappedLabels(std::deque<Label>& unmapped_labels, Points2d& ring_centers)
{
    logEnterFunction();
