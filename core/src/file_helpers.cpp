...
namespace file_helpers
{
    bool getReferenceFileName(const std::string& image, std::string& output)
    {
        ...
        if (pos_slash == std::string::npos || (temp != std::string::npos && temp > pos_slash))
        {
            pos_slash = temp;
        }
    ...
    bool isSupportedImageType(const std::string& filename)
    {
        ...
        if (idx != std::string::npos)
        {
            ...
            if (ext == "BMP" || ext == "DIB" || ext == "JPEG" || ext == "JPG" || ext == "JPE" || ext == "PNG" || ext == "PBM" || ext == "PGM" || ext == "PPM" ||
                ext == "SR" || ext == "RAS" || ext == "TIFF" || ext == "TIF") // nice vertical lines
            {
                return true;
            }
        }
