...
{
    Vec2d tl(x, y), tr(x + width, y), dl(x, y + height), dr(x + width, y + height);
...
Vec2d Algebra::linesIntersection(const Settings& vars, const Vec2d& p11, const Vec2d& p12, const Vec2d& p21, const Vec2d& p22)
{
...
double Algebra::pointProjectionCoef(const Vec2d& orig, const Vec2d& to_begin, const Vec2d& to_end)
{
    Vec2d a, b;
...
std::pair<Vec2d, Vec2d> Algebra::segmentProjection(const Vec2d& orig_begin, const Vec2d& orig_end, const Vec2d& to_begin, const Vec2d& to_end)
{
    Vec2d v1, v2, v3;
    double a1, a2;
...
bool Algebra::segmentsParallel(const Vec2d& b1, const Vec2d& e1, const Vec2d& b2, const Vec2d& e2, double eps, double* dist)
{
...
bool Algebra::SegmentsOnSameLine(const Settings& vars, Vec2d& b1, Vec2d& e1, Vec2d& b2, Vec2d& e2)
{
    Vec2d bdif, edif;
    bdif.diff(b1, b2);
    edif.diff(e1, e2);
